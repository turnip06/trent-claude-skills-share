---
name: kling-prompt-optimiser
description: Optimises text prompts and image inputs into production-ready Kling 3.0 video prompts. Use when the user wants to improve, rewrite, or optimise a prompt for Kling, or when they provide a rough idea and want a cinematic video prompt. Triggers on phrases like "optimise for Kling", "make this a Kling prompt", "improve this video prompt", "write a Kling prompt for this".
---
