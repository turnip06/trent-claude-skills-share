---
name: create-hco-ppt
description: Creates Howatson+Company branded PowerPoint presentations from markdown content. Triggers on requests to create PPT, presentation, deck, or slides, or mentions of HCO/Howatson templates.
---
