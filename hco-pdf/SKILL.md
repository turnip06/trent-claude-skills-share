---
name: hco-pdf
description: Creates professionally styled HTML documents using Howatson+Company's design system, then exports them as PDFs. Use when creating reports, guides, documentation, one-pagers, or any formatted H+Co document that needs to be downloaded as a PDF.
---

# H+Co PDF Document Creator

Create beautifully styled HTML documents using Howatson+Company's visual language, then export them as PDFs.
...
Use the full HTML template from @references/template.html as the starting point for every document.
...
2. **Copy fonts** to the working directory:
   ...
   cp /mnt/skills/user/hco-pdf/fonts/*.woff /home/claude/fonts/
   ```
