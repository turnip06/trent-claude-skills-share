---
name: clean-doc
description: Applies a clean, unbranded design system to documents (PDF, HTML, DOCX, Markdown) for personal or external use. Uses Manrope typography, neutral-focused palette, and generous spacing. Triggers on "style this", "format document", "make it professional", "clean doc", or any non-branded document styling request.
---
