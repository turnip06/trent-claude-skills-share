...
name: slide-prompter
description: >
  Analyses presentation slides to identify images needing generation and writes
  optimised Nano Banana Pro prompts for each. Use when asked to "prompt this
  deck", "write prompts for these slides", "what images need generating",
  "analyse slides for image gen", or given a deck to produce image generation
  prompts from. Recognises magenta boxes as designer instructions.
argument-hint: "[path to deck folder or PDF]"
---

# Slide Prompter

Analyse presentation slides one by one, identify images that need generating, and write production-ready Nano Banana Pro prompts for each.
...
After confirmation, write full prompts for each confirmed image. Follow the Nano Banana Pro prompting principles from `references/NANO-BANANA-PRO.md`.
...
- Refer to `references/NANO-BANANA-PRO.md` for prompt architecture and technical vocabulary.
