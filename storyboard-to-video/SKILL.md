...
description: Process storyboard images into individual 4K cinematic frames. Triggers when the user asks to "process this storyboard", "generate frames from this storyboard", "extract frames from storyboard", "storyboard to frames", or provides a storyboard image for frame generation. Does NOT trigger for single image generation, video generation, or prompt writing.
---
