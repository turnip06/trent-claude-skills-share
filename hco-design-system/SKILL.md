---
name: hco-design-system
description: Applies Howatson+Company's visual language with VC Nudge headings, Manrope body text, cream backgrounds, and category accent colors. Use when creating HTML documents for work, websites, landing pages, presentations, or styling for H+Co, Howatson+Company, Howatson and Company or even h co or hco.
---
