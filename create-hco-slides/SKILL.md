---
name: create-hco-slides
description: Creates Howatson+Company branded Google Slides presentations from markdown content using the gws CLI. Triggers on requests to create Google Slides, slide deck, or mentions of HCO/Howatson Google Slides. Outputs a shareable Google Slides URL.
---
