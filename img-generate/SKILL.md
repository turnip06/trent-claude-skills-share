---
name: img-generate
description: Generates three distinct image prompt variations exploring different technical approaches (lighting, focal length, composition, colour). Use when creating image prompts, requesting photo variations, or when users mention 'generate image', 'create prompt', 'photo ideas', or visual concepts.
---

# Prompt Generation System

Create three technically diverse variations of any image concept, each exploring different photographic approaches whilst maintaining the user's core vision.
...
**For special scenarios**: See [SCENARIOS.md](SCENARIOS.md)
...
**More examples**: See [EXAMPLES.md](EXAMPLES.md) for Product and Architectural generation examples.
...
**For iteration and refinement**: See [ITERATION.md](ITERATION.md)
