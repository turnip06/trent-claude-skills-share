...
Apply Howatson+Company's visual language to every output: **sleek, modern, novel, entertaining, and cool.**
...
- **Font file:** @VCNudge-ExtraBold.woff
...
- @colors.md — Full palette, CSS variables
- @typography.md — Fonts, sizes, heading styles
- @layout.md — Spacing, patterns, responsive
- @components.md — Cards, chips, buttons, etc.
- @images.md — Placeholders, styling, icons
- @animation.md — Motion, staggering, disclosure
...
Layouts are **guidelines, not rules**. Every use case is different. The reference patterns in @layout.md are starting points — adapt freely based on content needs.
