---
name: campaign-image-prompts
description: Generate cohesive image prompt suites for campaigns. Synthesises style from 0-5 reference images or concepts, then creates 2-20 variations maintaining consistent visual DNA while systematically varying scenes, subjects, or environments. Use when creating advertising campaigns, content series, brand imagery, or multi-image projects requiring unified aesthetic.
---

# Campaign Image Prompts

Generate suites of cohesive image prompts for campaigns. Maintain visual DNA across variations while systematically changing elements.
