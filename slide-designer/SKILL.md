...
name: slide-designer
description: >
  Designs presentation slides as HTML, screenshots them, visually evaluates
  against a design rubric, and autonomously iterates until quality passes.
  Use when asked to "design slides", "build a deck", "create presentation
  slides", "design my talk", "make slides look amazing", "style my
  presentation", or any request to visually design slide content into
  polished, presentation-ready HTML. Does NOT trigger for PowerPoint
  generation (use create-hco-ppt) or slide content writing.
---

# Slide Designer

Design presentation slides as self-contained HTML, visually evaluate them via Chrome screenshots, and autonomously iterate until a design rubric is met.
...
**Read `references/design-principles.md`** before writing any HTML. It contains the visual language, typography rules, color system, and layout patterns.
...
**Read `references/rubric.md`** for the full evaluation criteria.
...
|----------|------|---------|
| Design principles | [references/design-principles.md](references/design-principles.md) | Visual language, typography, color, layout rules |
| Rubric | [references/rubric.md](references/rubric.md) | Full evaluation criteria with examples |
| Template | [assets/template.html](assets/template.html) | Base HTML/CSS structure to start from |
