...
name: analyse-deck
description: >
  Analyses a deck and produces a structured breakdown. Use when
  asked to "analyse this deck", "break down this deck", "review this
  presentation", "what's in this deck", or given a folder of slide images
  or a PDF to review. Reads slides, identifies routes, searches for
  brand context, and infers the intent. Writes analysis alongside the input.
