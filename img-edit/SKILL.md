---
name: img-edit
description: Edit single images or combine multiple images into unified compositions. Use when you need to modify existing images (lighting, elements, details) or composite multiple sources whilst maintaining physical coherence and photorealistic integration.
---

# Image Editing & Composition Operations

Modify single images or combine multiple images with attention to lighting unification, shadow generation, depth relationships, and colour harmony.
...
- @references/common-scenarios.md — Walkthrough scenarios for common editing tasks
...
See @references/common-scenarios.md for detailed scenario walkthroughs (golden hour lighting, background removal, multi-image composites, weather effects).
