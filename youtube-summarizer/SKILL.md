...
description: Extracts transcripts from YouTube videos and creates actionable summaries with key insights, practical tips, and critical analysis. Generates a Markdown artifact in Claude.ai, iOS, or desktop; offers output options in Claude Code. Use when the user provides a YouTube URL and wants a summary, or asks to summarize or analyze YouTube content.
---

# YouTube Summarizer

This skill extracts transcripts from YouTube videos and creates focused, actionable summaries.
...
3. **Create the summary** following the template in `references/summary_template.md`
...
Read `references/EXAMPLE.md` to understand the expected tone and quality.
...
4. Read `references/EXAMPLE.md` for tone/quality reference
