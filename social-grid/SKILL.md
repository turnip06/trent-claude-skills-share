---
name: social-grid
description: Generates detailed Nano Banana Pro image prompts for social media phone grids. Takes a theme and expands it into a full prompt with phone layouts, platform overlays, and diverse people in selfie-style content. Triggers on "social grid", "phone grid", "social media grid", or references to making phone screen mockups with people.
---

# Social Grid Prompt Builder

Generate detailed natural-language prompts for Nano Banana Pro (`fal-ai/nano-banana-pro`) that produce grids of phone screens showing diverse people in social media content.
