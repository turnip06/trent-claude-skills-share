---
name: img-analyse
description: Reverse-engineer cinematic prompts from images (Style DNA extraction) or enhance existing text prompts with technical detail. Use when you need to recreate the look of an image or polish rough prompt ideas into production-ready descriptions.
---

# Image Analysis & Prompt Enhancement

Extract photorealistic prompt language from images or enhance text-based prompt ideas with technical precision.
