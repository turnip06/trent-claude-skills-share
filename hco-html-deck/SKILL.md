---
name: hco-html-deck
description: Creates professional HTML presentations using the Howatson+Company design template. Use when creating HTML slide decks or multi-slide content that needs Howatson+Company brand styling with ultra-condensed Anton typography, two-column layouts, and minimal design aesthetic.
---

# Howatson+Company Presentation Builder

Create professional HTML presentations using the Howatson+Company design template featuring ultra-condensed typography, bold colour palette, and grid-based layouts.
...
1. **Read the template**: Load `assets/template.html` to access the base HTML structure
